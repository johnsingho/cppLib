...
2020-10-16        H.Z.XIN        Change api string to wchar_t*
*****************************************************************************/
...
//------------------------------------------------------------------------------
int ZipCompress(
	const wchar_t* lpszSourceFiles,
	const wchar_t* lpszDestFile,
	int compressLevel/*=-1*/,
	const char* pszPassword/*=NULL*/,
	char bUtf8 /*= 0*/);


int ZipCompressMulti(
	TMultiSZ srcFileOrDirs,
	const wchar_t* lpszDestFile,
	int compressLevel/*=-1*/,
	const char* pszPassword/*=NULL*/,
	char bUtf8/* = 0*/);
...
//               -1 -- fail
//------------------------------------------------------------------------------
int ZipExtract(const wchar_t* lpszSourceFile,
			   const wchar_t* lpszDestFolder,
			   const char* pszPassword/*=NULL*/);
